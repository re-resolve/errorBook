...
//		System.out.println(String.format("StringToSign:%s%s", SIGN_SEP, stringToSign.toString()));
    ...
    public static void main(String[] args) throws Exception {
        ...
        SignUtil demo = new SignUtil();
        demo.ak = "MELRHZB3PBWUUBMWJPDG";
        demo.sk = "QBsYWvSA3CtGyp2EMBAgp9cNf6ZArAYwL8dZ7rjN";
        
        String bucketName = "test01-c.obs.cn-south-1.myhuaweicloud.com";
